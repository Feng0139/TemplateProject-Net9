...
namespace TemplateProject.Core.Middlewares.FluentMessageValidator;
    ...
    where TContext : IContext<IMessage>
{
    ...
    public MessageValidatorSpecification(
        IEnumerable<IFluentMessageValidator> messageValidators)
    {
